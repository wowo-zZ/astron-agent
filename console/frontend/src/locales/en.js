...
export const en = {
  ...
  pleaseReadInQuietEnvironment: 'Please read this text naturally and fluently in a quiet environment',
  ...
  speakerNameOnlySupport: 'Speaker name only supports English, numbers, spaces and underscore',
