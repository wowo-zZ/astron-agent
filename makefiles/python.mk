...
FLAKE8 := flake8 --max-line-length 88 --ignore=E203,W503,E501 --max-complexity 10 --exclude=.venv
MYPY := mypy --disallow-untyped-defs --disallow-incomplete-defs --check-untyped-defs --no-implicit-optional --ignore-missing-imports --explicit-package-bases --exclude '\.venv'
